...
export class Icon extends React.Component {
  ...
  render() {
    ...
    if (obj.flags & 0x02) {
      addon_hq = <L.Marker position={position}
                           icon={markers.GenerateHQIcon(obj.teamId)/*markers.iconarray[4][side()]*/}/>;
    }
    ...
    return (
      <React.Fragment>
        ...
        {addon_hq}
        {pulse}
        <L.Marker position={position} icon={objicon} opacity={opacity}
